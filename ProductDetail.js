...
const ProductDetail = ({ navigation},props) => {
      ...
      >
        ...
        <View style={[styles.container]}>
          ...
          <View style={{ padding: 8 ,marginBottom:100}}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  return (
                    <View>
                      <TouchableOpacity 
                      style={{borderColor: isColor ? 'red' : 'white',borderWidth: 0.5,padding: 5, marginTop: 5, borderRadius: 5 }}
                      onBlur={() => setIsFocused(false)}
                      onFocus={() => setIsColor(true)}
                      // onFocus={()=>setIsColor(false)}
                      >
                        <View style={[{ height: 35, width: 35, backgroundColor: item.color, borderRadius: 5 }]}
                        // onFocus={() => setIsColor(true)}
            ...
            <Text style={{color: 'black'}}>Composition and care</Text>
            <Text style={{color: 'black'}}>Find Your Size</Text>
            <Text style={{color: 'black'}}>Check In-stock availability</Text>
            <Text style={{color: 'black'}}>Delivery, exchange and return share</Text>
            </View>
            ...
            <View>
              <Text 
               numberOfLines={3}
              style={{color: 'black',fontSize:15}}>Sleeveless cropped top with a round neck and shoulder pads, featuring an elasticated hem and a buttoned opening at the back...</Text>
            </View>
